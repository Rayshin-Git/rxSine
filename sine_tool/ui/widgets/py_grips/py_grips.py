...
class PyGrips(QtWidgets.QWidget):
    def __init__(self, parent, position, disable_color=False):
        ...
        if position == "top_left":
            ...
            grip = QtWidgets.QSizeGrip(self.wi.top_left_grip)
        ...
        if position == "top_right":
            ...
            grip = QtWidgets.QSizeGrip(self.wi.top_right_grip)
        ...
        if position == "bottom_left":
            ...
            grip = QtWidgets.QSizeGrip(self.wi.bottom_left_grip)
        ...
        if position == "bottom_right":
            ...
            grip = QtWidgets.QSizeGrip(self.wi.bottom_right_grip)
